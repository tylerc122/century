          ...
          filteredEntries.map((entry) => {
            ...
            return (
              ...
              >
                ...
                <EntryCardContent>
                  <EntryCardHeader>
                    <EntryTitle isLocked={entry.isLocked}>{entry.isLocked ? '••••••••' : entry.title}</EntryTitle>
                    <EntryStatusIcons>
                  ...
                  <EntryPreview isLocked={entry.isLocked}>{entry.isLocked ? '••••••••••••••••••••••••••••••••••' : entry.content}</EntryPreview>
                </EntryCardContent>
